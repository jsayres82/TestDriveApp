...
public class ReservationController : Controller
{
    public ActionResult Edit(string id)
    {
        ...
        return View(new
        {
            ...
            Resource = new SelectList(Db.GetVehicleSelectList(), "Value", "Text", dr["RoomId"])
        });
    }
    ...
    public ActionResult Create()
    {
        return View(new 
        {
            ...
            Resource = new SelectList(Db.GetVehicleSelectList(), "Value", "Text", Request.QueryString["resource"])
        });
    }
    ...
    public ActionResult Create(FormCollection form)
    {
        DateTime start = Convert.ToDateTime(form["Start"]).Date.AddHours(12);
        DateTime end = Convert.ToDateTime(form["End"]).Date.AddHours(12);
        int text = Convert.ToInt32(form["Text"]);
